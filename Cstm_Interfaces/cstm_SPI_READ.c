 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 27 17:08:24 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME cstm_SPI_READ
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void cstm_SPI_READ_Start_wrapper(const uint32_T *SPI_Device, const int_T p_width0,
...
extern void cstm_SPI_READ_Outputs_wrapper(uint8_T *OutputByte,
...
static void mdlStart(SimStruct *S)
{
    ...
    cstm_SPI_READ_Start_wrapper(SPI_Device, p_width0, SPI_SS, p_width1, REGISTER, p_width2, MODE, p_width3, DATALENGTH, p_width4);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    cstm_SPI_READ_Outputs_wrapper(OutputByte, SPI_Device, p_width0, SPI_SS, p_width1, REGISTER, p_width2, MODE, p_width3, DATALENGTH, p_width4, y_width);
