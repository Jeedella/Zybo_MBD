 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 27 19:24:03 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME cstm_SPI_RW
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            1
/* Input Port  0 */
#define IN_PORT_0_NAME        InputByte
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       OutputByte
...
extern void cstm_SPI_RW_Start_wrapper(const uint32_T *SPI_Device, const int_T p_width0,
...
extern void cstm_SPI_RW_Outputs_wrapper(const uint8_T *InputByte,
			uint8_T *OutputByte,
...
static void mdlStart(SimStruct *S)
{
    ...
    const uint32_T *SPI_Device = (const uint32_T *) mxGetData(PARAM_DEF0(S));
    const uint32_T *SPI_SS = (const uint32_T *) mxGetData(PARAM_DEF1(S));
    const int32_T *REGISTER = (const int32_T *) mxGetData(PARAM_DEF2(S));
    const int32_T *MODE = (const int32_T *) mxGetData(PARAM_DEF3(S));
    const uint32_T *DATALENGTH = (const uint32_T *) mxGetData(PARAM_DEF4(S));
    
    cstm_SPI_RW_Start_wrapper(SPI_Device, p_width0, SPI_SS, p_width1, REGISTER, p_width2, MODE, p_width3, DATALENGTH, p_width4);
}
#endif /*  MDL_START */
...
{
    const uint8_T *InputByte = (uint8_T *) ssGetInputPortRealSignal(S, 0);
    uint8_T *OutputByte = (uint8_T *) ssGetOutputPortRealSignal(S, 0);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
    const int_T   p_width2  = mxGetNumberOfElements(PARAM_DEF2(S));
    const int_T   p_width3  = mxGetNumberOfElements(PARAM_DEF3(S));
    ...
    cstm_SPI_RW_Outputs_wrapper(InputByte, OutputByte, SPI_Device, p_width0, SPI_SS, p_width1, REGISTER, p_width2, MODE, p_width3, DATALENGTH, p_width4, y_width, u_width);
