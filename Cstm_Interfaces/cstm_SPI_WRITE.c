 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 27 16:01:45 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME cstm_SPI_WRITE
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void cstm_SPI_WRITE_Start_wrapper(const uint32_T *SPI_Device, const int_T p_width0,
...
extern void cstm_SPI_WRITE_Outputs_wrapper(const uint8_T *InputByte,
...
static void mdlStart(SimStruct *S)
{
    ...
    cstm_SPI_WRITE_Start_wrapper(SPI_Device, p_width0, SPI_SS, p_width1, REGISTER, p_width2, MODE, p_width3);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    cstm_SPI_WRITE_Outputs_wrapper(InputByte, SPI_Device, p_width0, SPI_SS, p_width1, REGISTER, p_width2, MODE, p_width3, u_width);
