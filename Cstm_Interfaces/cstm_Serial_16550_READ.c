 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Jun 29 16:35:36 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME cstm_Serial_16550_READ
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void cstm_Serial_16550_READ_Start_wrapper(const uint32_T *Port, const int_T p_width0,
...
extern void cstm_Serial_16550_READ_Outputs_wrapper(uint32_T *Data,
			uint32_T *Status,
...
static void mdlStart(SimStruct *S)
{
    ...
    cstm_Serial_16550_READ_Start_wrapper(Port, p_width0, BaudRate, p_width1, Parity, p_width2, StopBits, p_width3, DataLength, p_width4);
}
#endif /*  MDL_START */
...
{
    uint32_T *Data = (uint32_T *) ssGetOutputPortRealSignal(S, 0);
    uint32_T *Status = (uint32_T *) ssGetOutputPortRealSignal(S, 1);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
    const int_T   p_width2  = mxGetNumberOfElements(PARAM_DEF2(S));
    const int_T   p_width3  = mxGetNumberOfElements(PARAM_DEF3(S));
    ...
    cstm_Serial_16550_READ_Outputs_wrapper(Data, Status, Port, p_width0, BaudRate, p_width1, Parity, p_width2, StopBits, p_width3, DataLength, p_width4, y_width);
