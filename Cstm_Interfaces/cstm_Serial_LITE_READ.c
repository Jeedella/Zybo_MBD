...
#define S_FUNCTION_NAME cstm_Serial_LITE_READ
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Parameter 1 */
#define PARAMETER_1_NAME      DataLength
...
static void mdlStart(SimStruct *S)
{
    ...
    const uint32_T *DataLength = (const uint32_T *) mxGetData(PARAM_DEF1(S));
    
    cstm_Serial_LITE_READ_Start_wrapper(Port, p_width0, DataLength, p_width1);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    cstm_Serial_LITE_READ_Outputs_wrapper(Data, Status, Port, p_width0, DataLength, p_width1, y_width);
