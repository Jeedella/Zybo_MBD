 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Jun 29 16:44:04 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME cstm_Serial_LITE_Write
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void cstm_Serial_LITE_Write_Start_wrapper(const uint32_T *Port, const int_T p_width0);
extern void cstm_Serial_LITE_Write_Outputs_wrapper(const uint8_T *Data,
...
static void mdlStart(SimStruct *S)
{
    ...
    cstm_Serial_LITE_Write_Start_wrapper(Port, p_width0);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    cstm_Serial_LITE_Write_Outputs_wrapper(Data, Port, p_width0, u_width);
