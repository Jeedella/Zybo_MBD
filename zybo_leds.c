 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Mar 20 08:21:22 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME zybo_leds
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            1
/* Input Port  0 */
#define IN_PORT_0_NAME        LEDS
...
#define NPARAMS               1
/* Parameter 0 */
#define PARAMETER_0_NAME      LEDS_BASE_ADDR
...
extern void zybo_leds_Start_wrapper(real_T *xD,
			const uint32_T *LEDS_BASE_ADDR, const int_T p_width0);
extern void zybo_leds_Outputs_wrapper(const real_T *LEDS,
			const real_T *xD,
			const uint32_T *LEDS_BASE_ADDR, const int_T p_width0);
extern void zybo_leds_Update_wrapper(const real_T *LEDS,
			real_T *xD,
			const uint32_T *LEDS_BASE_ADDR, const int_T p_width0);
extern void zybo_leds_Terminate_wrapper(real_T *xD,
			const uint32_T *LEDS_BASE_ADDR, const int_T p_width0);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    const uint32_T *LEDS_BASE_ADDR = (const uint32_T *) mxGetData(PARAM_DEF0(S));
    
    zybo_leds_Start_wrapper(xD, LEDS_BASE_ADDR, p_width0);
}
#endif /*  MDL_START */
...
{
    const real_T *LEDS = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *xD = ssGetDiscStates(S);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const uint32_T *LEDS_BASE_ADDR = (const uint32_T *) mxGetData(PARAM_DEF0(S));
    
    zybo_leds_Outputs_wrapper(LEDS, xD, LEDS_BASE_ADDR, p_width0);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    zybo_leds_Update_wrapper(LEDS, xD, LEDS_BASE_ADDR, p_width0);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    zybo_leds_Terminate_wrapper(xD, LEDS_BASE_ADDR, p_width0);
