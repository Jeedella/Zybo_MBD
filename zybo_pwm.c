 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sun May 02 18:41:30 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME zybo_pwm
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void zybo_pwm_Start_wrapper(real_T *xD,
...
extern void zybo_pwm_Outputs_wrapper(const real_T *Duty,
			const real_T *En,
			const real_T *xD,
			const uint32_T *PWM_BASE_ADDR, const int_T p_width0,
			const uint32_T *PWM_PERIOD, const int_T p_width1,
			const uint32_T *DUTY_LOWER_LIMIT, const int_T p_width2,
			const uint8_T *MOTOR_DIR_DECODING, const int_T p_width3);
extern void zybo_pwm_Update_wrapper(const real_T *Duty,
			const real_T *En,
			real_T *xD,
			const uint32_T *PWM_BASE_ADDR, const int_T p_width0,
			const uint32_T *PWM_PERIOD, const int_T p_width1,
			const uint32_T *DUTY_LOWER_LIMIT, const int_T p_width2,
			const uint8_T *MOTOR_DIR_DECODING, const int_T p_width3);
extern void zybo_pwm_Terminate_wrapper(real_T *xD,
			const uint32_T *PWM_BASE_ADDR, const int_T p_width0,
			const uint32_T *PWM_PERIOD, const int_T p_width1,
			const uint32_T *DUTY_LOWER_LIMIT, const int_T p_width2,
			const uint8_T *MOTOR_DIR_DECODING, const int_T p_width3);
...
static void mdlStart(SimStruct *S)
{
    ...
    const uint32_T *PWM_BASE_ADDR = (const uint32_T *) mxGetData(PARAM_DEF0(S));
    const uint32_T *PWM_PERIOD = (const uint32_T *) mxGetData(PARAM_DEF1(S));
    const uint32_T *DUTY_LOWER_LIMIT = (const uint32_T *) mxGetData(PARAM_DEF2(S));
    const uint8_T *MOTOR_DIR_DECODING = (const uint8_T *) mxGetData(PARAM_DEF3(S));
    
    zybo_pwm_Start_wrapper(xD, PWM_BASE_ADDR, p_width0, PWM_PERIOD, p_width1, DUTY_LOWER_LIMIT, p_width2, MOTOR_DIR_DECODING, p_width3);
}
#endif /*  MDL_START */
...
{
    const real_T *Duty = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *En = (real_T *) ssGetInputPortRealSignal(S, 1);
    ...
    zybo_pwm_Outputs_wrapper(Duty, En, xD, PWM_BASE_ADDR, p_width0, PWM_PERIOD, p_width1, DUTY_LOWER_LIMIT, p_width2, MOTOR_DIR_DECODING, p_width3);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    zybo_pwm_Update_wrapper(Duty, En, xD, PWM_BASE_ADDR, p_width0, PWM_PERIOD, p_width1, DUTY_LOWER_LIMIT, p_width2, MOTOR_DIR_DECODING, p_width3);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    zybo_pwm_Terminate_wrapper(xD, PWM_BASE_ADDR, p_width0, PWM_PERIOD, p_width1, DUTY_LOWER_LIMIT, p_width2, MOTOR_DIR_DECODING, p_width3);
