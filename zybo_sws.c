 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Mar 20 08:26:21 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME zybo_sws
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define NPARAMS               1
/* Parameter 0 */
#define PARAMETER_0_NAME      SWS_BASE_ADDR
...
extern void zybo_sws_Start_wrapper(real_T *xD,
			const uint32_T *SWS_BASE_ADDR, const int_T p_width0);
extern void zybo_sws_Outputs_wrapper(real_T *SWS,
			const real_T *xD,
			const uint32_T *SWS_BASE_ADDR, const int_T p_width0);
extern void zybo_sws_Update_wrapper(real_T *SWS,
			real_T *xD,
			const uint32_T *SWS_BASE_ADDR, const int_T p_width0);
extern void zybo_sws_Terminate_wrapper(real_T *xD,
			const uint32_T *SWS_BASE_ADDR, const int_T p_width0);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    const uint32_T *SWS_BASE_ADDR = (const uint32_T *) mxGetData(PARAM_DEF0(S));
    
    zybo_sws_Start_wrapper(xD, SWS_BASE_ADDR, p_width0);
}
#endif /*  MDL_START */
...
{
    real_T *SWS = (real_T *) ssGetOutputPortRealSignal(S, 0);
    const real_T *xD = ssGetDiscStates(S);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const uint32_T *SWS_BASE_ADDR = (const uint32_T *) mxGetData(PARAM_DEF0(S));
    
    zybo_sws_Outputs_wrapper(SWS, xD, SWS_BASE_ADDR, p_width0);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    zybo_sws_Update_wrapper(SWS, xD, SWS_BASE_ADDR, p_width0);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    zybo_sws_Terminate_wrapper(xD, SWS_BASE_ADDR, p_width0);
